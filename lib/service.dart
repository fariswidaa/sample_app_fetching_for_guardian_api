...
void backgroundFetchHeadlessTask(String taskId) async {
  ...
  // This is where we're going to code our background task 
  // for the app.
  // we're going to save the data in the Database 
  // and read from it.

  print("[BackgroundFetch] Headless event received: $taskId");
  // when in background fetch data using bloc 
  // storing data in sqlite database 
  // use this method to access the data when in background 
